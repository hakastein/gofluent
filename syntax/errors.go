...
func getErrorMessage(code string, args []any) string {
	...
	case "E0003":
		return fmt.Sprintf("Expected token: \"%v\"", args[0])
	case "E0004":
		return fmt.Sprintf("Expected a character from range: \"%v\"", args[0])
	case "E0005":
		return fmt.Sprintf("Expected message \"%v\" to have a value or attributes", args[0])
	case "E0006":
		return fmt.Sprintf("Expected term \"-%v\" to have a value", args[0])
	case "E0008":
	...
	case "E0025":
		return fmt.Sprintf("Unknown escape sequence: \\%v.", args[0])
	case "E0026":
		return fmt.Sprintf("Invalid Unicode escape sequence: %v.", args[0])
	case "E0027":
