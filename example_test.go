...
// Example_localizationRussian wraps a Russian bundle in a Localization and
// renders messages by id with FormatValue: the { $n -> [one]… [few] …
...
func Example_localizationRussian() {
	const src = `
apples =
    { $n ->
        [one] { $n } яблоко
